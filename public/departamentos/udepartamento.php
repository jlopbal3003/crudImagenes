...
$id=$_GET['id'];
$datosDepartamentos=(new Departamentos)->devolverDepartamentos($id);
...
<html lang="es">
    ...
    <body style="background-color:#FFE87C">
        <h3 class="text-center">Actualizar departamento (<?php echo $datosDepartamentos->id ?>)</h3>
        <div class="container mt-2">
            <div class="bg-warning p-4 text-white rounded shadow-lg m-auto" style="width:35rem">
                <form name="udepartamento" action="<?php echo $_SERVER['PHP_SELF']."?id=$id"; ?>" method='POST'>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="n" name="nombre" value="<?php echo $datosDepartamentos->nombre ?>">
                    </div>
                    <div class="mb-3">
